...
(function($opal) {
  ...
  return (function($base) {
    ...
    def.$lazy = function() {
      ...
      return ($a = ($b = ($scope.Enumerator)._scope.Lazy).$new, $a._p = (TMP_21 = function(enum$, args){var self = TMP_21._s || this, $a;if (enum$ == null) enum$ = nil;args = $slice.call(arguments, 1);
    ...
    def.$slice_before = TMP_33 = function(pattern) {
      ...
      return ($a = ($b = $scope.Enumerator).$new, $a._p = (TMP_34 = function(e){var self = TMP_34._s || this, $a;if (e == null) e = nil;
  ...
  return (function($base, $super) {
    ...
    def.$join = function(sep) {
      ...
      for (var i = 0, length = self.length; i < length; i++) {
        ...
        self.$raise($scope.NoMethodError, "" + ((item).$inspect()) + " doesn't respond to #to_str, #to_ary or #to_s");
      }
...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;
  $opal.add_stubs(['$include', '$coerce', '$===', '$raise', '$class', '$__send__', '$send_coerced', '$to_int', '$respond_to?', '$==', '$enum_for', '$gcd', '$lcm', '$<', '$>', '$floor', '$/', '$%']);
  ;
  (function($base, $super) {
    function $Numeric(){};
